...
@Jornada(Jornadas.DEPOSITOS_E_SAQUES)
    public class QA17733 extends TesteBase {

        private ProvissionamentoDeSaqueFunc provissionamento = new ProvissionamentoDeSaqueFunc();

        @Test(description = "AGENDAR SAQUE COM CONTA INVALIDA")
        @Description("VALIDAR MENSAGEM DE RETORNO DE CONTA INVALIDA")

        @Severity(SeverityLevel.NORMAL)

        public void QA17733() throws Exception {
            ...
            provissionamento.validarMensagemDeRetorno(
                    MensagemRetornoMcir.CODIGO_DA_CONTA_INVALIDO.getCodigoRetorno(),
                    MensagemRetornoMcir.CODIGO_DA_CONTA_INVALIDO.getMensagemRetorno());
        }
    }
