...
@Jornada(Jornadas.DEPOSITOS_E_SAQUES)
    public class QA17739 extends TesteBase {
        ...
        public void QA17739() throws Exception {
            consultaConta(TipoConta.CONTA_NEXT_CPF,recuperarMassa(JSON.CPF));
            System.out.println(DadosConta.recuperarDadosConta(Conta.AGENCIA));
            ...
            provissionamento.ConsultaListaProvisionamentoDeSaque(
                    ...
                    retornaDataDiaUtil(366, "yyyy-MM-dd"),
