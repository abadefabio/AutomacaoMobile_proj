...
public class QA21298 extends TesteBase {

    ListarContatoFunc listarContatoFunc = new ListarContatoFunc();

    @Test(description = "Listar contas de destinatário (PARA MIM) sem resultado")
    @Description("VALIDAR MENSAGEM DE RETORNO")

    @Severity(SeverityLevel.NORMAL)

    public void QA21298() throws Exception {
        ...
        listarContatoFunc.validarListaContasDestinatarioVazia(CodigosRetorno.OK.getCodigo());
    }
}
