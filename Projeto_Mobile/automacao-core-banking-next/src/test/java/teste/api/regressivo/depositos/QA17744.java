...
@Jornada(Jornadas.DEPOSITOS_E_SAQUES)
    public class QA17744 extends TesteBase {
        ...
        public void QA17744() throws Exception {
           ...
           provissionamento.ConsultaListaProvisionamentoDeSaque(
                   ...
                   recuperarMassa("agencia"),
                    ...
                    retornaDataDiaUtil(266, "yyyy-MM-dd"),
                    CodigosRetorno.UNPROCESSABLE_ENTITY.getCodigo());

            provissionamento.validarMensagemDeRetorno(
                    MensagemRetornoMcir.LISTA_CODIGO_AGENCIA_INVALIDO.getCodigoRetorno(),
                    MensagemRetornoMcir.LISTA_CODIGO_AGENCIA_INVALIDO.getMensagemRetorno());
        }
