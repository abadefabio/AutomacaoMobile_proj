...
@Jornada(Jornadas.DEPOSITOS_E_SAQUES)
    public class QA17732 extends TesteBase {

        private ProvissionamentoDeSaqueFunc provissionamento = new ProvissionamentoDeSaqueFunc();

        @Test(description = "AGENDAR SAQUE COM AGENCIA VALIDA, NÃO PERTECENTE AO CPF/CNPJ")
        @Description("VALIDAR MENSAGEM DE RETORNO DE AGENCIA INVALIDA")

        @Severity(SeverityLevel.NORMAL)

        public void QA17732() throws Exception {
            ...
            provissionamento.inclusaoProvisionamento(
                    ...
                    retornaDataDiaUtil(23, "yyyy-MM-dd"),
                    recuperarMassa("valorSaque"),
                    CodigosRetorno.INTERNAL_SERVER_ERROR.getCodigo());

            provissionamento.validarMensagemDeRetorno(
                    MensagemRetornoMcir.ERRO_NAO_ESPERADO.getCodigoRetorno(),
                    MensagemRetornoMcir.ERRO_NAO_ESPERADO.getMensagemRetorno());
        }
    }
