...
@Jornada(Jornadas.DEPOSITOS_E_SAQUES)
    public class QA17737 extends TesteBase {

        private ProvissionamentoDeSaqueFunc provissionamento = new ProvissionamentoDeSaqueFunc();

        @Test(description = "CONSULTA AGENDAMENTO DE SAQUE COM DATA DE AGENDAMENTO SEM AGENDAMENTO")
        @Description("VALIDAR MENSAGEM DE RETORNO DE CONSULTA DE AGENDAMENTO SEM AGENDAMENTO")

        @Severity(SeverityLevel.NORMAL)

        public void QA17737() throws Exception {
