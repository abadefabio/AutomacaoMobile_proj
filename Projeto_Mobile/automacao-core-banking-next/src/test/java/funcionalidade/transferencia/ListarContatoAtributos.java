...
public class ListarContatoAtributos {
    ...
    /**
     * Retornar o header para requisição dos testes de Listar Contatos de Transferências
     *
     * @param token
     * @return
     */
    ...
    /**
     * Retornar o header para requisição dos testes de Listar Contatos de Transferências via Api Corporativa
     *
     * @param token
     * @param cpf
     * @return
