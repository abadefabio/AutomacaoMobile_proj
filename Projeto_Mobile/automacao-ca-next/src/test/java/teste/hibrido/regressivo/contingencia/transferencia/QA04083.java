...
public class QA04083 extends TesteBase {
    ...
    @Test(description = "EP - 32484 - 83552 - 19 - Validar transferência para mim, banco, de conta-corrente para Poupança TED. ")
    @Description("Pré-condições:" +
            "1. Possuir usuário e senha Next;\n" +
            "2. Estar com contingência ativada.")

    @Severity(SeverityLevel.NORMAL)
    public void QA04083() throws Exception {
