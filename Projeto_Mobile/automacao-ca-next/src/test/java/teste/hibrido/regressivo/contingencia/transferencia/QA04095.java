...
public class QA04095 extends TesteBase {
    ...
    @Test(description = "EP - 32484 - 83552 - 08 - Validar transferência outra pessoa, banco, de Poupança para Conta-Corrente DOC.")
    @Description("Pré-condições:" +
            "1. Possuir usuário e senha Next;" +
            "2. Estar com contingência esta ativada.")

    @Severity(SeverityLevel.NORMAL)
    public void QA04095() throws Exception {
