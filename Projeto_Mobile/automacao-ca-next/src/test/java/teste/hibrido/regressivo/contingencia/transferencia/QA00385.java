...
public class QA00385 extends TesteBase {
    ...
    @Test(description = "EP - 32484 - 32830 - 04 - Validar transferência para mim, banco, de conta-corrente para corrente DOC.")
    @Description("Pré-condições:" +
            "1. Possuir usuário e senha Next;\n" +
            "2. Estar com contingência ativada.")

    @Severity(SeverityLevel.NORMAL)
    public void QA00385() throws Exception {
