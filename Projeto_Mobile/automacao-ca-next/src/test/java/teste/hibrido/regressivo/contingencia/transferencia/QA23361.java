...
public class QA23361 extends TesteBase {
    ...
    @Test(description = "EP - 32484 - 32830 - 03 - Validar expiração do Qrcode e a transferência para mim, banco, de conta-corrente para corrente DOC")
    @Description("Pré-condições:" +
            "1. Possuir usuário e senha Next;\n" +
            "2. Estar com contingência ativada.")

    @Severity(SeverityLevel.NORMAL)
    public void QA23361() throws Exception {
