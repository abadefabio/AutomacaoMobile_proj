...
public class QA21867 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A4] [N2] Validar fluxo de proposta - Análise N1 > Solicita Reenvio > Reversão de Status > Análise N2 x N1 > Análise N2 > Reprova proposta")
    @Description("Descrição: Validar o fluxo de proposta - Preencher proposta > Análise N1 > Retorno Cliente > (Reverter Status) Análise N1 > P GCCN > Motor Segurança > Análise N2 > Análise N1 > P GCCN > Motor Segurança > Análise N2 > Reprova proposta > Resultado Adesão > Atualização Motor\n" +
            "\n" +
            "Pré-condições:\n" +
            "\n" +
            ...
            "\n" +
            "2- Possuir uma proposta pendente da análise N1 DO TIPO NEXT.")
