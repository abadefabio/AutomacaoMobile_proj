...
public class QA19428 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A3] Validar a análise de Proposta JOY II sem restrição e com análise N1 Recusado com Decisão igual Maior de 18 anos - Dependente")
    ...
    public void QA19428() throws Exception {
        ...
        conclusaoAnaliseFunc.selecionarResultadoEtapaDecisao(ComboN1.RECUSADO, ComboN1.MAIOR_DE_18_ANOS_DEPENDENTE);
