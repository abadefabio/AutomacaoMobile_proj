...
public class QA19438 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A3] Validar a análise de Proposta JOY II sem restrição, com análise N1 Recusado com Decisão igual Menor de 18 anos - Responsável e análise N2 SEM descrição na conclusão da análise")
    ...
    public void QA19438() throws Exception {
        ...
        conclusaoAnaliseFunc.selecionarResultadoEtapaDecisao(ComboN1.RECUSADO, ComboN1.MENOR_DE_18_ANOS_RESPONSÁVEL);
