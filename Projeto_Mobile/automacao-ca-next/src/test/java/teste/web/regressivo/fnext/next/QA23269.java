...
public class QA23269 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A4] [N2] Validar fluxo completo para proposta NEXT JOY II")
    @Description("Descrição: Validar fluxo Preencher proposta/ Análise N1/ P GCCN / Motor Segurança/ Análise N2/ Atualização Cadastral/ Gerente/ Resultado Adesão/ Atualização Motor para proposta next joy II.\n" +
            "\n" +
            "Pré-condições:\n" +
            "\n" +
    ...
    public void QA23269() throws Exception {
