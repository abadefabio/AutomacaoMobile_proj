...
public class QA14724 extends TesteBaseFnext {
    ...
    @Test(description = "Validar fluxo de proposta - Análise N1 > Deriva para N2 > Análise N2 com resultado Aprovado")
    @Description("1- Ter acesso ao FNEXT no ambiente em teste\n" +
            "\n" +
            "2- Possuir usuário com permissão para Tratar N1 (next)\n" +
            "\n" +
            "3 - Possuir usuário com pemissão para Tratar N2 (next)")
