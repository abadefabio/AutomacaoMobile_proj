...
public class QA20282 extends TesteBaseFrontEnd {
    ...
    @Test(description = "[QA AUT] Validar a inclusão de uma anotação como importante e depois retirar a flag de importante na timeline")
    @Description("Pré-condições:" +
            "1. Ter perfil de acesso ao Anotacoes\n" +
            "2. Possuir CPF valido para a criacao de uma anotacao;")
    @Severity(SeverityLevel.NORMAL)

    public void QA20282() throws Exception {
        ...
        anotacaoCad.validarAnotacaoImportanteTimeline("Importante");
        anotacaoCad.removerMarcacaoImportanteAnotacao();
        anotacaoCad.validarTextoModalImportante(AnotacaoGestaoStrings.TXT_REMOCAO_IMPORTANTE);
        anotacaoCad.validarTextoSucessoFlagImportanteClicarConfirmar(AnotacaoGestaoStrings.REMOCAO_IMPORTANTE_SUCESSO);
        anotacaoCad.validarremocaoMarcacaoImportante();
