...
public class QA17098 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A4] Validar fluxo de proposta -  Análise N1 > Deriva > Análise N2 > Reprovado")
    @Description("Descrição: Validar fluxo de proposta - Análise N1 > Deriva > Análise N2 > Reprovado\n" +
            "\n" +
            "Pré-condições:\n" +
            "\n" +
            ...
            "Pós-condições:\n" +
            "\n" +
            "A proposta é analisada com sucesso e reprovada.")
