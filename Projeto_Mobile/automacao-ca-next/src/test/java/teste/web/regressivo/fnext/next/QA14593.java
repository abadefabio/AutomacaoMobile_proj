...
public class QA14593 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A3] Validar os cards \"Informações da Proposta\" e \"Documentos\" na análise N1 de proposta NEXT com Liveness Negativo (Status \"3\")")
    @Description("Descrição: Validar os cards \"Informações da Proposta\" e \"Documentos\" na análise N1 de proposta NEXT com Liveness Negativo (Status \"3\")\n" +
            "\n" +
            "Pré-condições:\n" +
            "\n" +
            ...
            "\n" +
            "3- Possuir proposta next com Liveness Negativo (Status \"3\") em etapa Análise N1 - Tela Análise N1 - Em Andamento\n" +
            "\n" +
            "Pós-condições: Apresentar o campo Bureau de Face em vermelho e Frame Liveness.")
    @Severity(SeverityLevel.NORMAL)

    public void QA14593() throws Exception {
        ...
        documentosFunc.camposFrameLivenessSolicitaReenvioENaoFrameLivenessConfereDocIdentificacaoHabilitadoEComSelecao();
    }
