...
public class QA15980 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A4] - Validar Fluxo de Proposta NEXTJOY Análise N1 > Deriva > Análise N2 > Recusa N2")
    @Description("Descrição: Validar Fluxo de Proposta NEXTJOY Análise N1 > Deriva > Análise N2 > Recusa N2\n" +
            "\n" +
            "Pré-condições:\n" +
            "\n" +
    ...
    public void QA15980() throws Exception{
