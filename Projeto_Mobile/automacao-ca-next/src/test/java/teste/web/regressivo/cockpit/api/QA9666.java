...
public class QA9666 extends TesteBase {

    StatusCustomerApiFunc customerApiFunc = new StatusCustomerApiFunc();
    LoginFunc loginFunc = new LoginFunc();

    @Test(description = "Validar status de uma proposta em Adesao OnboardingStatus_2")
    @Description("Objetivo: validar status de uma proposta em Adesao Onboarding Status 1\n" +
            "\n" +
            "Pr�-requisito: CPF est� com uma ades�o no status 02\n" +
            "\n" +
            "P�s-condi��o:")

    @Severity(SeverityLevel.NORMAL)
    public void QA9666() throws Exception {
        ...
        customerApiFunc.validarStatusEDadosRequisicao(recuperarJSSONMassa("status_2"),2);
    }
}
