...
public class QA22826 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A4] [N1] Validar fluxo de proposta com Aprovação N1 e Reprovação Motor SADIF para proposta NEXT JOY")
    ...
    public void QA22826() throws Exception {
        ...
        dadosCadastraisFunc.marcarDadosCadastraisParaReprovaNextJoy(ComboN1.DATA_EMISSAO_DOC, ComboN1.CRM,ComboN1.AC);
