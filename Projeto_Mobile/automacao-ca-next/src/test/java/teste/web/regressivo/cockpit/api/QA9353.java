...
public class QA9353 extends TesteBase {

    LoginFunc loginFunc = new LoginFunc();
    DetailedCustomerInfoApiFunc customerInfo = new DetailedCustomerInfoApiFunc();

    @Test(description = "Validar retorno informações detalhadas da Visão360 - Cliente Next Representante")
    @Description("Objetivo: Validar retorno do micro serviço DetaledCustomerInfo, cliente Next representante\n" +
            "\n" +
            "Pré-requisito: Possuir um cliente Next representante ativo\n" +
            "\n" +
            "Pós-condição:")
    @Severity(SeverityLevel.NORMAL)
    public void QA9353() throws Throwable {
        ...
        customerInfo.validarInfoVisao360ClienteNext(cpf, recuperarJSSONMassa("validacaoVisao360"));
