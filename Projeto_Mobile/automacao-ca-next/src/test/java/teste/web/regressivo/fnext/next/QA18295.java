...
public class QA18295 extends TesteBaseFnext {
    ...
    @Test(description = "[A&A3] Validar a análise de Proposta JOY sem restrição, com análise N1 Recusado com Decisão igual Documento estrangeiro e análise N2 COM descrição na conclusão da análise")
