...
public class QA15995 extends TesteBaseFnext {
   LoginFunc loginFunc = new LoginFunc();
    ...
    @Test(description = "Validar fluxo de proposta - Validar Fluxo de Proposta - Análise N1 > Aprova")
    @Description("Descrição: Validar Fluxo de Proposta - Análise N1 > Aprova\n" +
            "\n" +
            "Pre-Condições" +
            "\n" +
            "1- Ter acesso ao FNEXT no ambiente em teste\n" +
            "2- Possuir usuário com permissão para Tratar N1 (next joy)\n" +
            "\n" +
            "Pós-Condições" +
            "\n" +
