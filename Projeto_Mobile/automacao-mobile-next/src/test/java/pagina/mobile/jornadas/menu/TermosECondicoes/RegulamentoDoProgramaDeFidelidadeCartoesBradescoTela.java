...
public class RegulamentoDoProgramaDeFidelidadeCartoesBradescoTela extends PaginaBase {

    public RegulamentoDoProgramaDeFidelidadeCartoesBradescoTela(AppiumDriver driver){
        super(driver);
    }
    ...
    public RegulamentoDoProgramaDeFidelidadeCartoesBradescoTela tocarFechar() throws Exception {
