...
public class ListaCondicoesGeraisVidaTela extends PaginaBase {

    public ListaCondicoesGeraisVidaTela(AppiumDriver driver) {
        super(driver);
    }
    ...
    public ListaCondicoesGeraisVidaTela validaTelaListaCondicoesGerais() throws Exception {
    ...
    public ListaCondicoesGeraisVidaTela visualizarCondicoesGerais() throws Exception {
    ...
    public ListaCondicoesGeraisVidaTela tocarBtnFecharTelaListaCondicoesGerais() throws Exception {
