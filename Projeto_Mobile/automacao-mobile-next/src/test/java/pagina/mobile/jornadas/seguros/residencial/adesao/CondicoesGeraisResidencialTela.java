...
public class CondicoesGeraisResidencialTela extends PaginaBase {

    public CondicoesGeraisResidencialTela(AppiumDriver driver) {
        super(driver);
    }
    ...
    public CondicoesGeraisResidencialTela validaTelaCondicoesGerais() throws Exception {
    ...
    public CondicoesGeraisResidencialTela tocarBtnVoltarTelaCondicoesGerais() throws Exception {
