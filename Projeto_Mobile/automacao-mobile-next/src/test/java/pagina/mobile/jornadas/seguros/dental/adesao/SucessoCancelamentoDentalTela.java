...
public class SucessoCancelamentoDentalTela extends PaginaBase {
    ...
    public SucessoCancelamentoDentalTela(AppiumDriver driver) {super(driver);}

    /**
     * Método para validar a tela de 'SUCCESSO DE CANCELAMENTO'
     * @return SucessoCancelamentoDentalTela
     * @throws Exception
     */
    @Step("Valida tela 'SUCCESSO DE CANCELAMENTO'")
    public SucessoCancelamentoDentalTela validaTelaSucessoCancelamento() throws Exception {
    ...
    public SucessoCancelamentoDentalTela tocarBotaoOk() throws Exception {
