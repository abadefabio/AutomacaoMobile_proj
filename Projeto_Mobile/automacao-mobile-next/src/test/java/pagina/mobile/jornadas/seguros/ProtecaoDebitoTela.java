...
public class ProtecaoDebitoTela extends PaginaBase {
    ...
    //Título do Header SUCESSO
    @AndroidFindBy(id = "br.com.bradesco.next:id/ntv_next_title")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"SUCESSO\"]")
    private MobileElement headerTituloSucesso;


    //Título do Header - termos e Condições
    @AndroidFindBy(id = "br.com.bradesco.next:id/ntv_next_title")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"TERMOS E CONDIÇÕES\"]")
    private MobileElement headerTituloTermosCondicoes;


    //Título - Card
    @AndroidFindBy(id = "br.com.bradesco.next:id/txtTitle")
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name=\"Cartão de Débito\"])[1]")
    private MobileElement tituloCard;

    //Subtítulo - Card
    @AndroidFindBy(id = "br.com.bradesco.next:id/txtSubtitle")
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name=\"Seguro Cartão de Débito\"])[1]")
    ...
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name=\"Proteja seu cartão de débito contra transações decorrentes de roubo do cartão ou coação.\"])[1]")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Cobertura\"]")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Vigência\"]")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Dados do parceiro\"]")
    ...
    public ProtecaoDebitoTela(AppiumDriver driver) {
        super(driver);
    }


    @Step("Validar layout do Card de Proteção")
    public ProtecaoDebitoTela validarLayoutCardProtecao() throws Exception {
    ...
    public ProtecaoDebitoTela navegarCardProtecao() throws Exception {
        int ind=0;
    ...
    public ProtecaoDebitoTela tocarBotaoContratar() throws Exception {
    ...
    public ProtecaoDebitoTela validarTelaConfirmacaoDeDados(ParticipantesProtecaoOdonto participantes) throws Exception {
    ...
    public ProtecaoDebitoTela validarSecaoInformacoesSeguro(TipoSecaoProtecao tipoSecaoProtecao, Protecao botao) throws Exception {
    ...
    public ProtecaoDebitoTela trocarDataPagamentoTelaCalendario() throws Exception {
    ...
    public ProtecaoDebitoTela acessarTermosCondicoes() throws Exception {
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela validarTelaTermosCondicoes() throws Exception {
        aguardarCarregamentoElemento(headerTituloTermosCondicoes);
        salvarEvidencia("Validar layout \"Termos e Condições\"");
        compararElementoTexto(headerTituloTermosCondicoes, Protecao.TERMOS_CONDICOES, MetodoComparacao.CONTEM);
        ...
        tocarElemento(headerBotaoFechar, "Erro ao tocar botão Fechar(x) Termo e Condicoes"); //<botão fechar>
        return this;
    }
    ...
    public ProtecaoDebitoTela tocarCheckBoxLiAceitoTermosCondicoes() throws Exception {
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela tocarBotaoContratarTelaConfirmacaoDeDados() throws Exception {
        rolaTelaBaixo();
    ...
    private void validarSecaoInformacoesSeguroCartaoFromConfirmacaoDadosTipoDebito(Protecao botao) throws Exception {
        ...
        compararElementoTexto(rodapeConfirmacaoDeDadosSecaoInformacoesDoSeguro,Protecao.RODAPE_INFORMACOES_DO_PRODUTO, MetodoComparacao.CONTEM);
        salvarEvidencia("Validar seção Informações do Seguro");

        aguardarCarregamentoElemento(botaoCoberturaInformacoesSeguro);
        tocarElemento(botaoCoberturaInformacoesSeguro, "Não foi possível clicar no botao \"Cobertura\"");
      //  compararElementoTexto(textoInternoCollapseAbaInformacoesDoSeguro, Protecao.COBERTURA_TEXTO_CARTAO, MetodoComparacao.CONTEM); // TODO -> VERIFICAR
        salvarEvidencia("Validar detalhes da Cobertura em informacoes do Seguro");
        tocarElemento(botaoCoberturaInformacoesSeguro, "Não foi possível clicar no botao \"Cobertura\"");
        ...
        tocarElemento(botaoVigenciaInformacoesSeguro, "Não foi possível clicar no botao \"Vigencia\"");
        rolaTelaBaixo();
     //   compararElementoTexto(textoInternoCollapseAbaInformacoesDoSeguro, Protecao.VIGENCIA_TEXTO_CARTAO, MetodoComparacao.CONTEM);// TODO -> VERIFICAR
        salvarEvidencia("Validar detalhes da Vigencia em informacoes do Seguro");
        tocarElemento(botaoVigenciaInformacoesSeguro, "Não foi possível clicar no botao \"Vigencia\"");

        aguardarCarregamentoElemento(botaoDadosDaSeguradoraInformacoesSeguro);
        tocarElemento(botaoDadosDaSeguradoraInformacoesSeguro, "Não foi possível clicar no botao \"Dados da Seguradora\"");
     //   compararElementoTexto(textoInternoCollapseAbaInformacoesDoSeguro, Protecao.DADOS_DA_SEGURADORA_TEXTO_CARTAO, MetodoComparacao.CONTEM);// TODO -> VERIFICAR
        salvarEvidencia("Validar detalhes dos Dados da seguradora em informacoes do Seguro");
        tocarElemento(botaoDadosDaSeguradoraInformacoesSeguro, "Não foi possível clicar no botao \"Dados da Seguradora\"");
        //TODO: swap para cima nao funciona nessa parte, estou tendo que voltar e entrar de novo para aparecer no topo da pagina
        tocarElemento(headerBotaoVoltar, "nao foi possivel clicar no botão voltar");
    ...
    public ProtecaoDebitoTela validarLayoutTelaConfirmacaoContratacao() throws Exception {
        aguardarCarregamentoElemento(headerTitulo);
        salvarEvidencia("Validar layout tela confirmação de contratação");
        compararElementoTexto(headerTituloSucesso, Protecao.SUCESSO, MetodoComparacao.CONTEM); //<headerTitulo sucesso>
    ...
    public ProtecaoDebitoTela validarLayoutCardContratado() throws Exception {
        aguardarCarregamentoElemento(headerTitulo);
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela validarTelaDetalhesCardContratado() throws Exception {
    ...
    public ProtecaoDebitoTela tocarBotaoDetalhesCardContratado() throws Exception {
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela validarAcioneSeguroTelaDetalhesCardContratado() throws Exception {
        aguardarCarregamentoElemento(headerTitulo);
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela tocarBotaoInformacoesSeguroOuPlano() throws Exception {
        rolaTelaBaixo();
    ...
    public ProtecaoDebitoTela tocarBotaoCancelarProtecao() throws Exception {
    ...
    public ProtecaoDebitoTela validarLayoutTelaCancelarProtecao() throws Exception {
    ...
    public ProtecaoDebitoTela selecionarMotivoCancelamento() throws Exception {
    ...
    public ProtecaoDebitoTela tocarBotaoConfirmarTelaCancelamentoProtecao() throws Exception {
    ...
    public ProtecaoDebitoTela validarLayoutTelaCancelamentoComSucesso() throws Exception {
        aguardarCarregamentoElemento(tituloHeaderTelaConfirmacaoCancelamento);
    ...
    public ProtecaoDebitoTela tocarBotaoConcluir(TipoSecaoProtecao tipoSecaoProtecao) throws Exception {
    ...
    public ProtecaoDebitoTela tocarBotaoVoltar() throws Exception {
