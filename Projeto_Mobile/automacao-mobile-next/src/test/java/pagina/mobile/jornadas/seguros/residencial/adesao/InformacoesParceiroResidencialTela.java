...
public class InformacoesParceiroResidencialTela extends PaginaBase {

    public InformacoesParceiroResidencialTela(AppiumDriver driver) {
        super(driver);
    }
    ...
    public InformacoesParceiroResidencialTela validaTelaSaibaMaisInfoParceiro() throws Exception {
    ...
    public InformacoesParceiroResidencialTela tocarBtnVoltarTelaSaibaMaisInfoParceiro() throws Exception {
