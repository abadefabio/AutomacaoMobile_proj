...
public class MassaQA21018 extends MassaQABase implements CasoDeTesteMassa {
    ...
    public JSONObject criar() throws Exception {
        ...
        new PortalInvestimento().realizarInvestimento(json, 534, 2000.00, LocalDateTime.now());
