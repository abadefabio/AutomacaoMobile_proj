...
public class MassaQA00043 extends MassaQABase implements CasoDeTesteMassa {
    ...
    public JSONObject criar() throws Exception {
        ...
        json.replace("cnpjPortabilidadePendente", mask.valueToString(cnpj));
        json.replace("cnpj", cnpj);
