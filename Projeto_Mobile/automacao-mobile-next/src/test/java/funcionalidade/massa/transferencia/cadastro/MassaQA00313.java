...
public class MassaQA00313 extends MassaQABase implements CasoDeTesteMassa {
    ...
    public JSONObject criar() throws Exception {
        ...
        json = new PortalContato().criarContatoMesmaTitularidadeRetornandoContato(arquivoJson, json.get("banco").toString(), json.get("agencia").toString(), json.get("conta").toString());
