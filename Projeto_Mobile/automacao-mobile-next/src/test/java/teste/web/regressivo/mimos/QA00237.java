...
public class QA00237 extends TesteBase{
    ...
    @Test(description = "REG.MIMO.01.07 - Validação de cadastramento de uma oferta HUB com base de voucher - Loja Online")
    @Description("Validar cadastramento de uma oferta HUB com base de voucher - Loja Online.")
    @Severity(SeverityLevel.NORMAL)

    public void QA00237() throws Exception{
        ...
        ofertasHubSistemaDeGestao.preencherCampoURLSite(recuperarMassa("url"));
