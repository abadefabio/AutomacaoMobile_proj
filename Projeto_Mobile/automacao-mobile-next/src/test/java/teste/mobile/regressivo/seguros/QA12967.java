...
public class QA12967 extends TesteBase {
    ...
    @Test(description = "QA12967 - Validar informações das Condições Gerais - VIDA")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para Validar informações das Condições Gerais - VIDA")

    @Severity(SeverityLevel.NORMAL)
    public void QA12967() throws Exception {
        ...
        segurosVidaAdesao.validarCondicoesGerais();
