...
public class QA17858 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados pagamento GNRE AIIM")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados do pagamento GNRE AIIM\n" +
            ".\n" +
    ...
    public void QA17858() throws Exception {
        ...
        comprovante.validarDadosComprovante(TextosComprovante.GNRE_AIIM, recuperarMassa("valor"));
