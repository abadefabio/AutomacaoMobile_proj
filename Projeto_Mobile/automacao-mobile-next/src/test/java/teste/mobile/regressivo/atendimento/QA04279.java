...
public class QA04279 extends TesteBase {

    LoginFunc login = new LoginFunc();
    MenuFunc menuFunc = new MenuFunc();
    ChatFunc chatFunc = new ChatFunc();

    @Test(description = "REG.CALL.03.03.04 - Validar no chat redirecionamento do deeplink Depósitos e Saques para a tela incial da funcionalidade.")
    ...
    public void QA04279() throws Exception{
        ...
        chatFunc.validarRedirecionamentoDeepLink(TitulosTelasRedirecionadas.DEPOSITOS_SAQUES, recuperarMassa("deepLink"), recuperarMassa("textoDeepLink"));
    }
