...
public class QA12923 extends TesteBase {
    ...
    @Test(description = "QA12923 - Validar informações das Condições Gerais - DENTAL")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para validar informações das Condições Gerais - DENTAL")

    @Severity(SeverityLevel.NORMAL)
    public void QA12923() throws Exception {
        ...
        segurosDentalAdesao.validarCondicoesGerais();
