...
public class QA20064 extends TesteBase {

    LoginFunc login = new LoginFunc();
    MenuFunc menu = new MenuFunc();
    SegurosResidencialAdesaoFunc segurosResidencialAdesao = new SegurosResidencialAdesaoFunc();

    @Test(description = "PBI.120116.US.121487.003 - Validar TELEFONES ÚTEIS - RESIDENCIAL")
    ...
    public void QA20064() throws Exception {

        login.efetuarLoginUsuarioExistente(recuperarMassa(JSON.CPF), recuperarMassa(JSON.SENHA));
        menu.selecionarSeguros();
        segurosResidencialAdesao.validarTelefonesUteisResidencial();
