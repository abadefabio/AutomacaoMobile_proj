...
public class QA17828 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados agendamento GPS (INSS-GPS)")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados agendamento GPS (INSS-GPS)\n" +
            "\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo GPS (INSS-GPS)\n" +
            "\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17828() throws Exception {
        ...
        comprovante.validarDadosComprovanteAgendamento(TextosComprovante.GPS, recuperarMassa("valor"));
