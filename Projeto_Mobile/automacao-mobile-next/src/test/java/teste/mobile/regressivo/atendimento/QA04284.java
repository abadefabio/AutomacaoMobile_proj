...
public class QA04284 extends TesteBase {

    LoginFunc login = new LoginFunc();
    MenuFunc menuFunc = new MenuFunc();
    ChatFunc chatFunc = new ChatFunc();

    @Test(description = "REG.CALL.03.03.09 - Validar no chat redirecionamento do deeplink Pagamentos para a tela incial da funcionalidade.")
    ...
    public void QA04284() throws Exception{
        ...
        chatFunc.validarRedirecionamentoDeepLink(TitulosTelasRedirecionadas.PAGAMENTOS, recuperarMassa("deepLink"), recuperarMassa("textoDeepLink"));
    }
