...
public class QA20315 extends TesteBase {
    ...
    @Test(description = "PBI.153634.153649.001 Verificar se é possível criar e refazer um perfil de investidor de usuário sem investimento e sem perfil através da nova Home de Investimentos")
    @Description("COMO Usuário de investimento NEXT\n" +
            ...
            "Não ter investimentos no app;\n" +
            "Não ter perfil de investidor.")
    @Severity(SeverityLevel.NORMAL)

    public void QA20315() throws Exception {
