...
public class QA12968 extends TesteBase {
    ...
    @Test(description = "QA12968 - Validar informações do Parceiro - VIDA")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para Validar informações do Parceiro - VIDA")

    @Severity(SeverityLevel.NORMAL)
    public void QA12968() throws Exception {
        ...
        segurosVidaAdesao.validarInformacoesParceiro();
