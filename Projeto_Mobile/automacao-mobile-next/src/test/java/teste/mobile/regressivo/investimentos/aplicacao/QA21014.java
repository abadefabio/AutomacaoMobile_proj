...
public class QA21014 extends TesteBase {
    ...
    @Test(description = "[v1] Validar primeira aplicação em um produto do segmento CDB")
    @Description("Descrição do cenário\n"
            + "COMO Usuário de investimento do NEXT\n"
            + "QUERO realizar a primeira aplicação em um produto do segmento CBD\n"
    ...
    public void QA21014() throws Exception {
        ...
        aplicacao.tocarBotaoInvestirPrimeiroProduto(Segmento.CDB, produto);
