...
public class QA17798 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar DADOS de agendamento DARF 153 CNPJ")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados de agendamento DARF 153 CNPJ\n" +
            ".\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo DARF 153 CNPJ\n" +
            "\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17798() throws Exception {
        ...
        comprovante.validarDadosComprovanteAgendamento(TextosComprovante.TRIBUTO_DARF, recuperarMassa("valor"));
