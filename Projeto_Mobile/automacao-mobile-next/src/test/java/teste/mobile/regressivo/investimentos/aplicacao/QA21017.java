...
public class QA21017 extends TesteBase {
    ...
    @Test(description = "[v1] Validar aplicação pelo botão INVESTIR pela carteira de investimentos do usuário")
    @Description("Descrição do cenário\n"
            + "COMO Usuário do NEXT\n"
            + "QUERO acessar meus investimentos\n"
            + "PARA adicionar valores a uma aplicação em andamento \n"
            + "\n"
            + "Pré-Condições:\n"
    ...
    public void QA21017() throws Exception {
        ...
        aplicacao.realizarAplicacaoNoProdutoJaInvestido(Segmento.CDB, produto, valor, solicitacoes);
