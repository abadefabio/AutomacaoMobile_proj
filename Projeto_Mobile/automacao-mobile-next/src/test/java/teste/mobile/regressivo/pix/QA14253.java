...
public class QA14253 extends TesteBase {
    ...
    public void QA14253() throws Exception {

        login.efetuarLoginUsuarioExistente(recuperarMassa(JSON.CPF), recuperarMassa(JSON.SENHA));

        menu.selecionarPix();

        meusLimitesPix.validarEdicaoLapisLimiteMaiorMinhasContasContatosPixContaCorrente(ValorPix.ALEATORIO_MINIMO);

        meusLimitesPix.validarEdicaoLapisLimiteMaiorMinhasContasContatosPixContaCorrente(ValorPix.ALEATORIO_MAXIMO);
    }
}
