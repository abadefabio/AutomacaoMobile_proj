...
public class QA04281 extends TesteBase {

    private LoginFunc login = new LoginFunc();
    private MenuFunc menuFunc = new MenuFunc();
    private ChatFunc chatFunc = new ChatFunc();

    @Test(description = "REG.CALL.03.03.06 - Validar no chat redirecionamento do deeplink Mimos para a tela incial da funcionalidade.")
    ...
    public void QA04281() throws Exception{
        ...
        chatFunc.validarRedirecionamentoDeepLink(TitulosTelasRedirecionadas.MIMOS, recuperarMassa("deepLink"), recuperarMassa("textoDeepLink"));
