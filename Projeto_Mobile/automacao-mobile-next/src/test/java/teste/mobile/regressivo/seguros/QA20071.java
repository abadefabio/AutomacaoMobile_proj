...
public class QA20071 extends TesteBase {
    ...
    @Test(description = "PBI.120116.US.121487.010 - Validar recontratação apartir do card com status CANCELADO - RESIDENCIAL")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para validar recontratação à partir do card com status CANCELADO \"<\"")
