...
public class QA17818 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados agendamento GNRE AIIM")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados agendamento GNRE AIIM\n" +
            ".\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo GNRE AIIM\n" +
            "\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17818() throws Exception {
        ...
        comprovante.validarDadosComprovanteAgendamento(TextosComprovante.GNRE, recuperarMassa("valor"));
