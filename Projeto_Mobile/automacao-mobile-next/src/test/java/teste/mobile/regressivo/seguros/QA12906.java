...
public class QA12906 extends TesteBase {
    ...
    @Test(description = "QA12906 - Contratar Produto - DÉBITO")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para contratar Produto - DÉBITO")

    @Severity(SeverityLevel.NORMAL)
    public void QA12906() throws Exception {
        ...
        segurosDebitoAdesao.contratarProdutoCredito();
