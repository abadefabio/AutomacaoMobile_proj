...
public class QA12932 extends TesteBase {
    ...
    @Test(description = "QA12932 - Validar informações das Coberturas - RESIDENCIAL")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para validar informações das Coberturas - RESIDENCIAL")

    @Severity(SeverityLevel.NORMAL)
    public void QA12932() throws Exception {
        ...
        segurosResidencialAdesaoFunc.validarDetalhesProduto();
