...
public class QA17863 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar comprovante pagamento GNRE 0099")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados de pagamento GNRE 0099\n" +
            ".\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo GNRE 0099\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17863() throws Exception {
