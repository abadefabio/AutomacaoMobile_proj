...
public class QA22706 extends TesteBase {
    LoginFunc login = new LoginFunc();
    MenuFunc menu = new MenuFunc();
    SegurosCreditoAdesaoFunc segurosCreditoAdesaoFunc = new SegurosCreditoAdesaoFunc();

    @Test(description = "PBI.120115.US.121486.003 - Validar TELEFONES ÚTEIS - CRÉDITO")
    ...
    public void QA22706() throws Exception {

        login.efetuarLoginUsuarioExistente(recuperarMassa(JSON.CPF), recuperarMassa(JSON.SENHA));
        menu.selecionarSeguros();
        segurosCreditoAdesaoFunc.validarTelefonesUteis(TipoSeguroContratado.SEGURO_CREDITO);
