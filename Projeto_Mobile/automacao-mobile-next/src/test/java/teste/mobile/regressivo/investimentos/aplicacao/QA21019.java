...
public class QA21019 extends TesteBase {
    ...
    @Test(description = "[v1] Validar aplicação pelo botão INVESTIR pela carteira de investimentos do usuário na Poupança")
    ...
    public void QA21019() throws Exception {
        ...
        aplicacao.realizarAplicacaoNoProdutoPoupancaJaInvestido(
                Segmento.POUPANCA,
                produto,
                valor,
                saldoInvestido);
