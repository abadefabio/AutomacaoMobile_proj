...
public class QA17853 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados agendamento GNRE DIDSI")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar dados de agendamento GNRE DIDSI\n" +
            ".\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo GNRE DIDSI\n" +
            "\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17853() throws Exception {
        ...
        comprovante.validarDadosComprovante(TextosComprovante.GNRE, recuperarMassa("valor"));
