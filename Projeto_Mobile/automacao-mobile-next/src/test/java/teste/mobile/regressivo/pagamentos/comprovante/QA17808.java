...
public class QA17808 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados agendamento GARE 120")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar DADOS de agendamento GARE 120\n" +
            ".\n" +
    ...
    public void QA17808() throws Exception {
        ...
        comprovante.validarDadosComprovanteAgendamento(TextosComprovante.GARE, recuperarMassa("valor"));
