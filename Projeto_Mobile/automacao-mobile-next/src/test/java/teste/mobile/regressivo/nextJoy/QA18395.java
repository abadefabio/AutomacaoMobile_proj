...
public class QA18395 extends TesteBase {

    LoginFunc login = new LoginFunc();
    CadastroDadosDependenteFunc cadastroNextJoy = new CadastroDadosDependenteFunc();

    @Test(description = "[Adesões Táticas] PBI129025 - 3 -  Validar adesão joy status 0, substituindo o primeiro responsável - status 5, para o  segundo responsável - status 1   Next x Next ")
    ...
    public void QA18395() throws Exception {
