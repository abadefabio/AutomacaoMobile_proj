...
public class QA12922 extends TesteBase {
    ...
    @Test(description = "QA12922 - Validar informações das Detalhadas do Plano - DENTAL")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para validar informações das Detalhadas do Plano - DENTAL")

    @Severity(SeverityLevel.NORMAL)
    public void QA12922() throws Exception {
        ...
        segurosDentalAdesao.validarDetalhesProduto();
