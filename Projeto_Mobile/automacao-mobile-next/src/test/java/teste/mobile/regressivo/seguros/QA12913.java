...
public class QA12913 extends TesteBase {
    ...
    @Test(description = "QA12913 - Validar informações das Condições Gerais - CRÉDITO")
    @Description("Eu enquanto cliente\n" +
            "Quero acessar a Jornada de Seguros no App do next\n" +
            "Para validar informações das Condições Gerais - CRÉDITO")

    @Severity(SeverityLevel.NORMAL)
    public void QA12913() throws Exception {
        ...
        segurosCreditoAdesao.validarCondicoesGerais();
