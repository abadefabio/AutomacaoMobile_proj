...
public class QA17873 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar comprovante pagamento GPS (INSS-GPS)")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar comprovante pagamento GPS (INSS-GPS)\n" +
            ".\n" +
    ...
    public void QA17873() throws Exception {
        ...
        comprovante.validarDadosComprovante(TextosComprovante.GPS, recuperarMassa("valor"));
