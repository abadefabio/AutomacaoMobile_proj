...
public class QA03408 extends TesteBase {
    ...
    @Test(description = "REG.ADS.01.02.01 - Validar termo de adesão proposta de abertura de conta")
    @Description("Descrição" +
            "• Garantir que o termo adesão proposta de abertura de conta e apresentado conforme esperado." +
            "Pré requisitos:" +
