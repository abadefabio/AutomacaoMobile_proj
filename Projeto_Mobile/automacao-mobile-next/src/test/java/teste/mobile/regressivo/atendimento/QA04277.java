...
public class QA04277 extends TesteBase {

    private LoginFunc login = new LoginFunc();
    private MenuFunc menuFunc = new MenuFunc();
    private ChatFunc chatFunc = new ChatFunc();

    @Test(description = "REG.CALL.03.03.02 - Validar no chat redirecionamento do deeplink Cartão para a tela incial da funcionalidade.")
    ...
    public void QA04277() throws Exception{
        ...
        chatFunc.validarRedirecionamentoDeepLink(TitulosTelasRedirecionadas.CARTAO, recuperarMassa("deepLink"), recuperarMassa("textoDeepLink"));
