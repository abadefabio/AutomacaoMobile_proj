...
public class QA04280 extends TesteBase {

    LoginFunc login = new LoginFunc();
    MenuFunc menuFunc = new MenuFunc();
    ChatFunc chatFunc = new ChatFunc();

    @Test(description = "REG.CALL.03.03.05 - Validar no chat redirecionamento do deeplink Limites para a tela incial da funcionalidade.")
    ...
    public void QA04280() throws Exception{
        ...
        chatFunc.validarRedirecionamentoDeepLink(TitulosTelasRedirecionadas.CREDITO, recuperarMassa("deepLink"), recuperarMassa("textoDeepLink"));
    }
}
