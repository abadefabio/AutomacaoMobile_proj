...
public class QA17868 extends TesteBase {
    ...
    @Test(description = "[Transações Cotidianas] PBI - 110302 Validar dados pagamento GR-PR")
    @Description("Descrição (Objetivo):\n" +
            "\n" +
            "Validar Validar do pagamento GR-PR\n" +
            ".\n" +
            "Dados do teste (Massa necessária):\n" +
            "Ter um cod. barras do tributo pagamento GR-PR\n" +
            "\n" +
            "Pré requisitos:\n" +
            "\n" +
            "Ser cliente Next\n" +
    ...
    public void QA17868() throws Exception {
        ...
        comprovante.validarDadosComprovante(recuperarMassa("descricao"), recuperarMassa("valor"));
